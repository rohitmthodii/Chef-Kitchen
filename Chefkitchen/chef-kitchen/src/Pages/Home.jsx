  ...
  return (
    <div
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center h-full px-4 gap-4">
        ...
        {/* IMAGE */}
        <img src={Heroimage1} alt="Chef Kitchen" className="w-[350px] rounded-xl bg-black/25 shadow-2xl border-l-4 border-b-4 border-gray-600/60"/>

        <img src={Heroimage2} alt="" className="w-[150px] absolute backdrop-blur-md bg-black/20 rounded-full mb-60 sm:mb-60 md:mb-44"/>
